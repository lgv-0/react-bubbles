...
We want the password to be sent as least times as possible, the token is used in place as a temporary means of verifying someone is actually authenticated with the server
...
Getting reqeusts, parsing, replying????
